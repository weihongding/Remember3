...
public class ColorAdapter_RcUnq_set extends RecyclerView.Adapter<ColorAdapter_RcUnq_set.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_choose_color.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ColorUtil.choose_color_rcUnq_set = color;
                ...
                MyDialog.colorDialog_rcUnq_set.hide();
